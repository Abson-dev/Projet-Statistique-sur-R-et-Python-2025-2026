...
# ║   Profilage démographique des ménages nigérians                             ║
# ║                                                                             ║
...
# │  POURQUOI CE SCRIPT ?                                                      │
# │                                                                            │
# │  Ce script orchestre l'ensemble du projet TP1. Il centralise :             │
...
cat("╔═══════════════════════════════════════════════════════════════════╗\n")
cat("║                                                                 ║\n")
cat("║   TP1 GHS Nigeria — Lancement du pipeline d'analyse             ║\n")
...
cat("│  Analyses univariées, pyramide, tests, tableau gtsummary       │\n")
cat("└─────────────────────────────────────────────────────────────────┘\n\n")
...
cat("╔═══════════════════════════════════════════════════════════════════╗\n")
cat("║                                                                 ║\n")
cat("║   *  Pipeline TP1 execute avec succes                          ║\n")
cat("║                                                                 ║\n")
...
cat("║   │                                                       │     ║\n")
cat("║   │  data/sect1_clean.rds                                 │     ║\n")
cat("║   │  outputs/figures/fig00_diagnostic_NA.png              │     ║\n")
cat("║   │  outputs/figures/fig01_histogramme_age.png            │     ║\n")
cat("║   │  outputs/figures/fig02_boxplot_age.png                │     ║\n")
cat("║   │  outputs/figures/fig03_pyramide_ages.png              │     ║\n")
cat("║   │  outputs/figures/fig04_parente_barplot.png            │     ║\n")
cat("║   │  outputs/figures/fig05_boxplot_taille_menage.png      │     ║\n")
cat("║   │  outputs/tables/tableau_gtsummary_rural_urbain.html   │     ║\n")
cat("║   │  outputs/tables/tableau_gtsummary_rural_urbain.csv    │     ║\n")
cat("║   └───────────────────────────────────────────────────────┘     ║\n")
cat("║                                                                 ║\n")
