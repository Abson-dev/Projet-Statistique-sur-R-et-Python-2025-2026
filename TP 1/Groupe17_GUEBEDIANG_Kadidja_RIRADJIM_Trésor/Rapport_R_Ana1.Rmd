...
```{r fig.cap="Visualisation des valeurs manquantes"}
...
```{r fig.cap="Distribution de l’âge"}
...
```{r fig.cap="Lien de parenté avec le chef de ménage"}
...
```{r fig.cap="Répartition urbain / rural"}
...
```{r fig.cap="Distribution de la taille des ménages"}
