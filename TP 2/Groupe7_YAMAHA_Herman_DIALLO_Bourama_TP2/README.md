...
│
├── outputs/
│   ├── fig01_distribution_niveau_education.png     # Distribution globale du niveau d'éducation
│   ├── fig02_education_par_sexe.png                # Niveau d'éducation par sexe (100% empilé)
│   ├── fig03_education_par_age.png                 # Niveau d'éducation par groupe d'âge
│   ├── fig04_scolarisation_par_zone.png            # Scolarisation 6-17 ans par zone
│   ├── fig05_heatmap_analphabetisme_etat.png       # Taux sans instruction par État
│   └── fig06_heatmap_education_etat.png            # Distribution des niveaux par État
│
└── README.md
```
...
| Indicateur | Résultat |
|:---|:---|
| Adultes (18+) dans l'analyse | ~16 000 individus |
| Part sans aucune instruction | > 70 % des adultes |
| Test Chi-deux (éducation × sexe) | χ² ≈ 79,8 ; p < 0,001 ; V de Cramér ≈ 0,077 |
| Test Kruskal-Wallis (éducation × âge) | χ² ≈ 1 304,8 ; p < 0,001 |
| Jeunes adultes (18-30) vs ainés | Niveau d'éducation significativement plus élevé |
| Taux de scolarisation — Urbain | ~90 % des 6-17 ans |
| Taux de scolarisation — Rural | ~73 % des 6-17 ans |
| Test Chi-deux (scolarisation × zone) | χ² ≈ 277,4 ; p < 0,001 |
| États les plus touchés (quintile 5) | Zamfara, Kebbi, Katsina, Sokoto, Yobe |
| États les mieux instruits (quintile 1) | Lagos, Edo, Anambra, Imo, Rivers |
