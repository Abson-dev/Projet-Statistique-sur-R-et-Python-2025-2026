...
dossier <- "C:/Users/HP/Desktop/ISE1 CL/Semestre2/Projet statistique avec R ou python/Dossier R/TP/TP5/docs"
setwd(dossier)
...
cat("Terminé : Rapport.docx\n")
cat("Ouvrez dans Word et faites Ctrl+A puis F9 pour mettre à jour la TOC.\n")
