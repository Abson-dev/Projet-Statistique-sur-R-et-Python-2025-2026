...
# ║   Santé | Accès aux soins et dépenses de santé                              ║
# ║                                                                             ║
...
# │  POURQUOI CE SCRIPT ?                                                      │
# │                                                                            │
# │  Ce script orchestre l'ensemble du projet TP3. Il centralise :             │
...
cat("╔═══════════════════════════════════════════════════════════════════╗\n")
cat("║                                                                 ║\n")
cat("║   TP3 GHS Nigeria — Lancement du pipeline d'analyse             ║\n")
...
cat("│  Analyses santé, tests statistiques, visualisations            │\n")
cat("└─────────────────────────────────────────────────────────────────┘\n\n")
...
cat("╔═══════════════════════════════════════════════════════════════════╗\n")
cat("║                                                                 ║\n")
cat("║   *  Pipeline TP3 execute avec succes                          ║\n")
cat("║                                                                 ║\n")
...
cat("║   │                                                       │     ║\n")
cat("║   │  data/processed/df_sante_clean.rds                    │     ║\n")
cat("║   │  outputs/figures/fig01a_morbidite_sexe.png            │     ║\n")
cat("║   │  outputs/figures/fig01b_morbidite_age.png             │     ║\n")
cat("║   │  outputs/figures/fig02_types_maladies.png             │     ║\n")
cat("║   │  outputs/figures/fig03_recours_soins_prestataire.png │     ║\n")
cat("║   │  outputs/figures/fig04a_depenses_distribution.png     │     ║\n")
cat("║   │  outputs/figures/fig04b_depenses_prestataire.png      │     ║\n")
cat("║   │  outputs/figures/fig05_recours_quintile.png           │     ║\n")
cat("║   │  outputs/figures/fig06_depenses_milieu.png            │     ║\n")
cat("║   │  outputs/tables/tab01_gtsummary_sante.html            │     ║\n")
cat("║   │  outputs/tables/tab01_gtsummary_sante.csv             │     ║\n")
cat("║   └───────────────────────────────────────────────────────┘     ║\n")
cat("║                                                                 ║\n")
